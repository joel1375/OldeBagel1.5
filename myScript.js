...
function sandwich() {
  ...
  document.getElementById("dailysoup").style.display = "none";
  document.getElementById("dailybuttonsandwich").style.contrast = "100%";
  document.getElementById("dailybuttonsoup").style.contrast = "0";
}

function soup() {
  document.getElementById("dailysandwich").style.display = "none";
  document.getElementById("dailysoup").style.display = "block";
  document.getElementById("dailybuttonsandwich").style.contrast = "0";
  document.getElementById("dailybuttonsoup").style.contrast = "100%";
}
